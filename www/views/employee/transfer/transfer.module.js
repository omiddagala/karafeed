    ...
    function transferCtrl($scope, fileReader, $filter, $uibModal, $http, $rootScope, localStorageService, $state, toastrConfig, toastr) {
        ...
        $scope.searchColleagues = function () {
            ...
            delayTimer = setTimeout(function () {
                ...
                $http.post("https://api.karafeed.com/v1/employee/findCompanyCoWorkerByName",
                    //$("#colNameToSearch").val(), 
        ...
        $scope.doTransfer = function (form) {
            ...
            $http.post("https://api.karafeed.com/v1/employee/employeeToEmployeeTransfer", param, httpOptions)
