...
var demo = (function (window, undefined) {
    ...
    var SELECTORS = {
        pattern: '.pattern',
        card: '.art_card',
        cardImage: '.art_card__image',
        cardClose: '.art_card__btn-close',
    };
    ...
    function _playSequence(isOpenClick, id, e) {
        ...
        if (!card.isOpen) {
            ...
            setTimeout(function () {
                $("#responsive-filter-emp").css("z-index", "-2");
            });
        } else {
            // Close sequence.
            ...
            setTimeout(function () {
                $("#responsive-filter-emp").css("z-index", "999");
            },2000);
            ...
            setTimeout(function () {
                $("#omid_content").css("display", "none");
                $(".page-top").css("opacity", "1");
                $(".menu-top").css("opacity", "1");
                $(".al-sidebar").css("opacity", "1");
                $(".row").css("opacity", "1");
            }, 2000)
        }
